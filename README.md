...
2022.10.03 | V1.0.0 | - Updated property value of EPC:0x82 in case of Release A from "A" (0x41) to "a" (0x61)</br>- Removed "O" from options of Release Version at Register a new EOJ screen</br>- Added a method to launch this program by "npm start"
